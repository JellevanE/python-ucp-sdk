...
def _get_model_config():
  """Returns model name based on available API keys"""
  if os.getenv("OPENAI_API_KEY"):
    return "openai/gpt-5-mini"  # or "openai/gpt-4o" for better performance
  elif os.getenv("GOOGLE_API_KEY"):
    return "gemini-2.5-flash"
  else:
    raise ValueError("No API key found. Set either OPENAI_API_KEY or GOOGLE_API_KEY")
